...
func main() {
	...
	api.GET("/health", func(c *gin.Context) {
		c.JSON(200, gin.H{"success": true, "data": gin.H{"status": "ok", "version": "2.0.10-go"}})
	})
	...
	api.GET("/moments/recent-tags", handler.MomentRecentTags)
	...
	// Coding/GitHub activity page data
	api.GET("/coding", handler.GetCodingData)
