...
// Expected to be a release tag like "v1.0.11" (or "dev" for local runs).
var BuildVersion = ""
...
func fetchLatestRelease() {
	...
	// how the current build displays v1.0.11 · 3ac2f03. Silent on
...
// name (e.g., "v1.0.11") into the 7-char short SHA of the commit it
