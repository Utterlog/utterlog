    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px', flexWrap: 'wrap' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', marginRight: 'auto' }}>
          <span className="text-dim" style={{ fontSize: '13px' }}>{items.length} 件好物</span>
        </div>
        <Button onClick={openCreate}><i className="fa-regular fa-plus" style={{ fontSize: '16px' }} />添加好物</Button>
      </div>
