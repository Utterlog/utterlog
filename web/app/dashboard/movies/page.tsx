...
import { Film, Plus, Edit2, Trash2, Star } from '@/components/icons';
    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <Film size={20} className="text-primary-themed" />
          <h1 className="text-main" style={{ fontSize: '18px', fontWeight: 700 }}>电影</h1>
        </div>
        <div style={{ marginLeft: 'auto' }}>
          <Button onClick={openCreate}><Plus size={16} />添加电影</Button>
        </div>
      </div>
