  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 mb-4 text-sm text-sub">
        <button onClick={() => router.push('/dashboard/pages')} className="hover:text-main transition-colors">页面管理</button>
        <span>/</span>
        <span className="text-main font-medium">新建页面</span>
      </div>
          ...
          <div className="bg-card border border-line rounded-[4px] p-4 space-y-3">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  type="button"
                  className="text-xs text-primary-themed flex items-center gap-1 hover:opacity-80"
