      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '15px', flexShrink: 0 }}>
          {iconLinks.map((item, i) => {
            ...
            const onEnter = (e: React.MouseEvent<HTMLElement>) => { e.currentTarget.style.color = '#F53102'; e.currentTarget.style.borderColor = '#F53102'; };
          ...
          <div style={{ position: 'relative' }}>
            <button
              ...
              onMouseEnter={e => { e.currentTarget.style.color = '#F53102'; e.currentTarget.style.borderColor = '#F53102'; }}
                ...
                {!needTotp ? (
                  <form onSubmit={handleLogin}>
                    <div style={{ marginBottom: '12px' }}>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          border: 'none', background: '#FFE9E2', outline: 'none',
                    ...
                    <button type="submit" disabled={loginLoading} style={{
                      ...
                      background: '#F53102', color: '#fff', border: 'none', cursor: 'pointer',
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: '#fff', color: '#F53102',
                        border: '1px solid #F53102', cursor: 'pointer',
                  ...
                  <form onSubmit={handle2FA}>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                      ...
                      <button type="submit" disabled={loginLoading} style={{
                        ...
                        background: '#F53102', color: '#fff', border: 'none',
            ...
            {user && showLogin && (
              <div ref={loginRef} style={{
                ...
                <button onClick={handleLogout} style={{
                  display: 'block', width: '100%', padding: '8px 16px', fontSize: '13px', color: '#F53102',
