  ...
  return (
    <div style={{ padding: '0' }}>
      ...
      <div style={{
        ...
        {catName && (
          <Link prefetch={false} href={`/categories/${post.categories[0].slug}`} style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', color: '#F53102', textDecoration: 'none', marginLeft: 'auto' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: '13px', color: '#999', display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
          ...
          />
          <Link prefetch={false} href="/" style={{ color: '#F53102', textDecoration: 'none', fontWeight: 600 }}>{post.author?.nickname || post.author?.username || '匿名'}</Link>
          <span>本文采用</span>
