...
import { ShoppingBag, Plus, Edit2, Trash2, Star } from '@/components/icons';
    ...
    <div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '20px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <ShoppingBag size={20} className="text-primary-themed" />
          <h1 className="text-main" style={{ fontSize: '18px', fontWeight: 700 }}>好物</h1>
        </div>
        <div style={{ marginLeft: 'auto' }}>
          <Button onClick={openCreate}><Plus size={16} />添加好物</Button>
        </div>
      </div>
